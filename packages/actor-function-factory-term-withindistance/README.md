...
capable of evaluating the [withinDistance](http://www.opengis.net/def/function/geosparql/withinDistance) function.
...
```bash
$ yarn add @comunica/actor-function-factory-term-withindistance
```
...
```text
{
  "@context": [
    ...
    "https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-function-factory-term-withindistance/^5.0.0/components/context.jsonld"
  ],
  "actors": [
    ...
    {
