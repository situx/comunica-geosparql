...
import { TermFunctionMinX } from './TermFunctionMinX';

/**
 * A comunica TermFunctionSimplify Function Factory Actor.
 */
export class ActorFunctionFactoryTermMinX extends ActorFunctionFactoryDedicated {
