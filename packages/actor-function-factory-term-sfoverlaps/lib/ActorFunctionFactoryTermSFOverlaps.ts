...
import { TermFunctionSFOverlaps } from './TermFunctionSFOverlaps';

/**
 * A comunica TermFunctionTouches Function Factory Actor.
 */
export class ActorFunctionFactoryTermSFOverlaps extends ActorFunctionFactoryDedicated {
  ...
  Promise<T extends { requireTermExpression: true } ? IActorFunctionFactoryOutputTerm : IActorFunctionFactoryOutput> {
    return new TermFunctionSFOverlaps();
  }
}
