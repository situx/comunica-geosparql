...
export enum GeoSparqlExtOperator {
  ...
  FULLYWITHINDISTANCE = 'http://www.opengis.net/def/function/geosparql/ext/fullyWithinDistance',
  ...
  MINIMUMBOUNDINGRADIUS = 'http://www.opengis.net/def/function/geosparql/ext/minimumBoundingRadius',
...
export enum GeoSparqlOperator {
  ...
  MINIMUMBOUNDINGCIRCLE = 'http://www.opengis.net/def/function/geosparql/minimumBoundingCircle',
