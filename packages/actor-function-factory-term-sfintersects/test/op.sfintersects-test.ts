...
import { ActorFunctionFactoryTermSFIntersects } from '../lib';

describe('like \'sfIntersects\' receiving', () => {
  runFuncTestTable({
    registeredActors: [
      args => new ActorFunctionFactoryTermSFIntersects(args),
      args => new ActorFunctionFactoryExpressionBnode(args),
    ],
    arity: 1,
    aliases: bool,
    notation: Notation.Function,
    operation: 'sfIntersects',
    testTable: `
