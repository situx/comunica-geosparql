...
import { ActorFunctionFactoryTermEHDisjoint } from '../lib';

describe('like \'ehDisjoint\' receiving', () => {
  runFuncTestTable({
    registeredActors: [
      args => new ActorFunctionFactoryTermEHDisjoint(args),
      args => new ActorFunctionFactoryExpressionBnode(args),
    ],
    arity: 2,
    aliases: bool,
    notation: Notation.Function,
    operation: 'ehDisjoint',
    testTable: `
